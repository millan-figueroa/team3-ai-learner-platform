    ...
    <div className="min-h-screen bg-linear-to-r from-blue-50 to-indigo-100 flex items-center justify-center p-6">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
        ...
        <p className="mb-4 text-gray-600 text-center">
          Quick setup so we can personalize your learning path.
        </p>
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-col">
            ...
            >
              ...
              <option value="advanced">Advanced (work experience)</option>
            </select>
          </div>
          ...
          <details className="mt-2">
            ...
            <pre className="bg-gray-100 p-4 rounded-lg mt-2 overflow-x-auto text-xs">
              {JSON.stringify({ ...learnerData, preferences: prefs }, null, 2)}
            </pre>
          </details>
