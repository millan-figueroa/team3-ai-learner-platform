...
const NavBar: React.FC<NavBarProps> = ({ 
  ...
  return (
    <div className={`${isCollapsed ? 'w-16' : 'w-64'} bg-white shadow-lg border-r border-gray-200 min-h-screen transition-all duration-300 ${className}`}>
      ...
      {onToggleCollapse && (
        <div className="p-4 border-b border-gray-200">
          ...
          >
            ...
            {!isCollapsed && <span className="ml-2 text-sm text-gray-600">Collapse</span>}
          </button>
        </div>
      )}
